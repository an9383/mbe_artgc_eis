...
namespace KR.MBE.CommonLibrary.Utils
{
    public static class XMLHandler
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public static XmlDocument makeEISMessageSet(DataTable dt)
        {
        ...
        public static string makeNode(string Key, string Value)
        {
        ...
        public static StringBuilder makeNode(string Key, StringBuilder Value)
        {
        ...
        /// <returns></returns>
        private static XmlNode findParentNode(XmlNode node, int nodeSEQ)
        {

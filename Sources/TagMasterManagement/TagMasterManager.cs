...
namespace TagMasterManagement
{
    ...
    public class TagMasterManager
    {
        ...
        public string TAGLIST = " SELECT EQUIPMENTID, TAGID, SITEID, DESCRIPTION, ADDRESS "
        ...
        {
            EventLogger.EventLogger.Instance.Information("Tag Master Manager Starting");
        ...
        private void InitializeEventTagDataList()
        {
            ...
            m_dtEventTag.Columns.Add("SiteID", typeof(string));
        ...
        private void InitializeMonitoringTagDataList()
        {
            ...
            m_dtMonitoringTagList.Columns.Add("SITEID", typeof(string));
        ...
        private void InitializeAlarmTagDataList()
        {
            ...
            m_dtAlarmTagList.Columns.Add("SITEID", typeof(string));
        ...
        public void MakeTagList()
        {
            ...
            for (int i = 0; i < dsResult.Tables[0].Rows.Count; i++)
            {
                ...
                tdTagInfo.sSiteID = dsResult.Tables[0].Rows[i]["SITEID"].ToString();
        ...
        public void MakeMonitoringTagList()
        {
            ...
            for (int i = 0; i < dtResult.Rows.Count; i++)
            {
                ...
                drMonitoring["SITEID"] = dsResult.Tables[0].Rows[i]["SITEID"].ToString();
        ...
        public void MakeEventTagList(string sDataBase)
        {
            ...
            for (int i = 0; i < dtResult.Rows.Count; i++)
            {
                ...
                drEvent["SiteID"] = dtResult.Rows[i]["SITEID"].ToString();
        ...
        public void MakeAlarmTagList()
        {
            ...
            for (int i = 0; i < dtResult.Rows.Count; i++)
            {
                ...
                drAlarm["SITEID"] = dsResult.Tables[0].Rows[i]["SITEID"].ToString();
        ...
        private bool ConnectLocalDB()
        {
            try
            {
                ...
                {
                    //m_cnnLocalDB.ConnectionString = eventLogger.getINIValue("DBCONNECTION", "MAINDBConnection");
                    m_cnnLocalDB.Open();
                }
